...
class _RegisterState extends State<Register> {
  ...
  Future<void> _register() async {
    ...
    // Validate ID is exactly 10 digits
    if (id.length != 10 || !RegExp(r'^\d{10}$').hasMatch(id)) {
      setState(() {
        _errorMsg = "Student ID must be exactly 10 digits (e.g., 6631501187)";
      });
      return;
    }
    ...
    try {
      await AuthService.register(id, name, password);
      ...
      setState(() {
        _isLoading = false;
        _errorMsg = e.toString().replaceAll('Exception: ', '').replaceAll('Registration failed: ', '');
      });
    }
  }
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          TextField(
                            ...
                            maxLength: 10,
                            style: TextStyle(color: Colors.white),
                            decoration: _fieldDecoration(hint: '10-digit student ID').copyWith(
