...
class _EditAssetPageState extends State<EditAssetPage> {
  ...
  Future<void> _loadUserInfo() async {
    ...
    final profileImage = await UserSession.getCurrentProfileImage();
    setState(() {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      items: _statuses
                          .where((e) {
                            // Only show "Disabled" option if current status is "Available"
                            if (e == 'Disabled' && widget.initialStatus != 'Available') {
                              return false;
                            }
                            return true;
                          })
                    ...
                    ElevatedButton(
                      onPressed: () {
                        // Validation: Can only disable Available assets
                        if (_status == 'Disabled' && widget.initialStatus != 'Available') {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Only available assets can be disabled'),
